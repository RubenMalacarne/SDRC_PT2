...
#include "coppelia_description/coppelia_sim_hardware_interface.hpp"
...
PLUGINLIB_EXPORT_CLASS(coppelia_description::CoppeliaSimHardwareInterface, hardware_interface::SystemInterface)
