...
namespace action_servers
{
    ...
    bool PlaceActionServer::approach_place_pose(const interfaces::msg::ObjectInfo object_info, const geometry_msgs::msg::Point point)
    {
        geometry_msgs::msg::Pose start_pose = arm_group_->getCurrentPose().pose;
        geometry_msgs::msg::Pose target_pose = start_pose;
    ...
    bool PlaceActionServer::open_gripper(const interfaces::msg::ObjectInfo object_info){
        ...
        auto detach_request = std::make_shared<interfaces::srv::AttachObject::Request>();
